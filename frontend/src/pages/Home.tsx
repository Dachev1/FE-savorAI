 ...
 *  Manages the decorative animated circles in the background.
 * ----------------------------------------------------------------- */
 ...
 *  Renders the main hero image, heading, subheading, and CTAs.
 * ----------------------------------------------------------------- */
...
/** ------------------------------------------------------------------
 *  Subcomponent: HeroImage
 *  Renders the hero image portion of the page.
 * ----------------------------------------------------------------- */
const HeroImage: React.FC = () => (
  <div className="relative md:w-1/2 flex justify-center items-center" data-aos="fade-up">
    <img
 ...
 *  Displays the main heading, subheading, and action buttons.
 * ----------------------------------------------------------------- */
const HeroText: React.FC = () => (
  <div className="md:w-1/2 flex flex-col items-start space-y-8" data-aos="fade-right">
    ...
    <p className="text-base sm:text-lg lg:text-xl text-dark/80 leading-relaxed">
      Revolutionize your cooking experience with SavorAI's intelligent recipe 
      recommendations and planning tools. The future of effortless cooking 
      starts here!
    </p>
