...
const AIGeneratedMealCard: React.FC<AIGeneratedMealCardProps> = ({
  ...
  return (
    <>
      <div
        className="mt-10 bg-white rounded-2xl shadow-lg p-8 transition-transform duration-300 hover:scale-[1.02] border border-gray-100"
        data-aos="fade-up"
      >
        ...
        <div className="relative overflow-hidden rounded-xl mb-6 flex justify-center">
          <img
            src={recipe.imageUrl}
            alt={recipe.mealName}
            className="w-[512px] h-[512px] object-cover transform hover:scale-105 transition-transform duration-500 md:w-[400px] md:h-[400px] sm:w-[300px] sm:h-[300px]"
          />
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-6">
          <button
            onClick={openModal}
            className="flex items-center justify-center py-3 px-6 rounded-lg bg-gradient-to-r from-accent to-dark text-white font-semibold text-lg shadow-md transition-transform duration-300 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-dark"
          ...
          <div className="flex flex-col items-center space-y-6">
            ...
            <div className="w-full">
              ...
              <ul className="list-none space-y-1">
                <li className="text-lg text-dark">
                  Calories: {recipe.recipeDetails.nutritionalInformation.calories}
                </li>
                <li className="text-lg text-dark">
                  Protein: {recipe.recipeDetails.nutritionalInformation.protein}
                </li>
                <li className="text-lg text-dark">
                  Carbohydrates: {recipe.recipeDetails.nutritionalInformation.carbohydrates}
                </li>
                <li className="text-lg text-dark">
                  Fat: {recipe.recipeDetails.nutritionalInformation.fat}
                </li>
              </ul>
            </div>
          </div>
