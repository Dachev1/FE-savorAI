            ...
            {recipe.recipeDetails && 
              ...
              <div className="bg-gradient-to-r from-white to-gray-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-8 shadow-xl">
                <div className="flex items-center gap-4 mb-8 justify-center">
                  ...
                  <h3 className="text-3xl font-bold bg-gradient-to-r from-accent to-blue-600 bg-clip-text text-transparent">Serving Suggestions</h3>
                </div>
                <div className="grid md:grid-cols-2 gap-6">
                  {recipe.recipeDetails.servingSuggestions.map((suggestion, idx) => (
                    <div key={idx} 
                      className="flex items-center gap-4 p-4 rounded-xl bg-white dark:bg-gray-700 shadow-md hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300">
                      <FaChevronRight className="text-accent text-xl" />
                      <span className="text-gray-700 dark:text-gray-200 text-lg">{suggestion}</span>
                    </div>
                  ))}
                </div>
              </div>
             ...
             recipe.recipeDetails.nutritionalInformation && (
              <div className="bg-gradient-to-r from-white to-gray-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-8 shadow-xl">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  {Object.entries(recipe.recipeDetails.nutritionalInformation).map(([key, value]) => (
                    <div key={key} 
